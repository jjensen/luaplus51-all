...
if exist p4api-2010.1.265509-vs2008_dyn rmdir /s /q p4api-2010.1.265509-vs2008_dyn
wget ftp://ftp.perforce.com/perforce/r10.1/bin.ntx86/p4api_vs2008_dyn.zip
unzip p4api_vs2008_dyn.zip
ren p4api-2010.1.265509-vs2008_dyn p4api\release
...
if exist p4api-2010.1.265509-vs2008_dyn_vsdebug rmdir /s /q p4api-2010.1.265509-vs2008_dyn_vsdebug
wget ftp://ftp.perforce.com/perforce/r10.1/bin.ntx86/p4api_vs2008_dyn_vsdebug.zip
unzip p4api_vs2008_dyn_vsdebug.zip
ren p4api-2010.1.265509-vs2008_dyn_vsdebug p4api\debug
